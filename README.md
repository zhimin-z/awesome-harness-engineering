...
- [HEAAL — AI Intent Language for declarative, goal-driven program execution](https://github.com/hyun06000/AIL) — HEAAL/AIL: An AI-Intent Language where programs declare goals and constraints while a harness enforces safety by construction. Enables reliable AI execution through structured intent specification rather than imperative instructions.
